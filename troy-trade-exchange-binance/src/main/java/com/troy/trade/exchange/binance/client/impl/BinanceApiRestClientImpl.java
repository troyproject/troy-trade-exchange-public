...
import static com.troy.trade.exchange.binance.client.impl.BinanceApiServiceGenerator.executeSync;
...
public class BinanceApiRestClientImpl implements BinanceApiRestClient {
  ...
  @Override
  public List<Trade> getMyTrades(String symbol, Integer limit, Long fromId, Long recvWindow, Long timestamp, Long startTime, Long endTime) {
  ...
  public List<Trade> getMyTrades(String symbol, Integer limit) {
    return getMyTrades(symbol, limit, null, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis(),null,null);
  }

  @Override
  public List<Trade> getMyTrades(String symbol) {
    return getMyTrades(symbol, null, null, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis(),null,null);
  }
  ...
  public DepositHistory getDepositHistory(String asset,Long startTime,Long endTime) {
    return executeSync(binanceApiService.getDepositHistory(asset, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis(),startTime,endTime));
  }

  @Override
  public WithdrawHistory getWithdrawHistory(String asset,Long startTime,Long endTime) {
    return executeSync(binanceApiService.getWithdrawHistory(asset, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis(),startTime,endTime));
  }
