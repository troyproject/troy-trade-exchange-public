package com.troy.trade.exchange.binance.dto.event;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.troy.trade.exchange.binance.dto.BinanceApiConstants;

import com.troy.trade.exchange.binance.dto.market.OrderBookEntry;
...
public class DepthEvent {
  ...
  /**
   * updateId to sync up with updateid in /dddddd/v1/depth
   */
  @JsonProperty("u")
