...
public interface BinanceApiAsyncRestClient {
   ...
   */
  void getMyTrades(String symbol, Integer limit, Long fromId, Long recvWindow, Long timestamp, Long startTime, Long endTime, BinanceApiCallback<List<Trade>> callback);
