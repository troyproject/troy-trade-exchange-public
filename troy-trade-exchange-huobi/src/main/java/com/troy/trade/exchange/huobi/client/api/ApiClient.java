...
import com.troy.trade.exchange.huobi.dto.request.BatchCancelOpenOrdersRequest;
...
import com.troy.trade.exchange.huobi.dto.request.IntrustOrdersDetailRequest;
...
public class ApiClient {
    ...
    static final String API_HOST_HADAX = "api.hadax.com";

    static final String API_URL = "https://" + API_HOST;
    static final String API_URL_HADAX = "https://" + API_HOST_HADAX;
    ...
    /**
     * /v1/common/symbols 查询Pro站支持的所有交易对及精度
     *
     ...
     * @return
     */
    public List<Symbol> getSymbolsHadax() {
        ApiResponse<List<Symbol>> resp =
                get("/v1/hadax/common/symbols", null, new TypeReference<ApiResponse<List<Symbol>>>() {
                });
        return resp.checkAndReturn();
    }
     ...
     * @return
     */
    public String trade(CreateOrderRequest request) {
        String url = "/v1/order/orders/place";
        if (StringUtils.equals(request.getSymbolType(), HuobiConstant.EXCH_ACCT_SYMBOL_TYPE_HADAX)) {
            url = "/v1/hadax/order/orders/place";
        }
        ApiResponse<String> resp = post(url, request,
                new TypeReference<ApiResponse<String>>() {
                });
        return resp.checkAndReturn();
    }
    ...
    /**
     * GET /xxxxx/history/kline 获取K线数据
     *
     * @param symbol
     * @param period
     * @return
     */
    public KlineResponse kline(String symbol, String period,Integer size) {
        ...
        KlineResponse resp = get("/xxxxx/history/kline", map, new TypeReference<KlineResponse<List<Kline>>>() {
        });
        return resp;
    }

    /**
     * GET /xxxxx/detail/merged 获取聚合行情(Ticker) Pro交易所
     *
     * @param symbol
     * @return
     */
    public MergedResponse merged(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        MergedResponse resp = get("/xxxxx/detail/merged", map, new TypeReference<MergedResponse<Merged>>() {
        });
        return resp;
    }

    /**
     * GET /xxxxx/detail/merged 获取聚合行情(Ticker) Hadax交易所
     *
     * @param symbol
     * @return
     */
    public MergedResponse mergedHadax(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        MergedResponse resp = getHadax("/xxxxx/detail/merged", map, new TypeReference<MergedResponse<Merged>>() {
        });
        return resp;
    }
     ...
     * @return
     */
    public DepositWithDrawResponse queryDepositWithdraw(String symbol,String type,String from,String size) {
        HashMap map = new HashMap();
        map.put("currency", symbol);
        map.put("type", type);
        map.put("from", from);
        map.put("size", size);
        DepositWithDrawResponse resp = get("/v1/query/deposit-withdraw", map, new TypeReference<DepositWithDrawResponse<DepositWithDraw>>() {
        });

        logger.warn("调用火币充提币记录 入参："+ JSONObject.toJSONString(map)+"，返回结果:"+JSONObject.toJSONString(resp));
        return resp;
    }

    /**
     * GET /xxxxx/depth 获取 Market Depth 数据
     *
     * @param request
     * @return
     */
    public DepthResponse depth(DepthRequest request) {
        ...
        DepthResponse resp = get("/xxxxx/depth", map, new TypeReference<DepthResponse<List<Depth>>>() {
        });
        return resp;
    }

    /**
     * GET /xxxxx/xxxxx 获取 Trade Detail 数据
     *
     * @param symbol
     * @return
     */
    public TradeResponse trade(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        TradeResponse resp = get("/xxxxx/xxxxx", map, new TypeReference<TradeResponse>() {
        });
        return resp;
    }

    /**
     * GET /xxxxx/history/xxxxx 批量获取最近的交易记录
     *
     * @param symbol
     * @param size
     * @return
    ...
    public HistoryTradeResponse historyTrade(String symbol, String size) {
        ...
        map.put("symbol", symbol);
        map.put("size", size);
        HistoryTradeResponse resp = get("/xxxxx/history/xxxxx", map, new TypeReference<HistoryTradeResponse>() {
        });
        return resp;
    }

    /**
     * GET /xxxxx/detail 获取 Market Detail 24小时成交量数据
     *
     * @param symbol
     * @return
     */
    public DetailResponse detail(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        DetailResponse resp = get("/xxxxx/detail", map, new TypeReference<DetailResponse<Details>>() {
        });
        return resp;
    }
     ...
     * @return
     */
    public SymbolsResponse symbolsHadax(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        SymbolsResponse resp = get("/v1/hadax/common/symbols", map, new TypeReference<SymbolsResponse<Symbols>>() {
        });
        return resp;
    }
     ...
     *                  symbolType -- 交易对类型，pro-火币pro、hadax-火币hadax
     * @return
     */
    public BalanceResponse balance(String accountId) {
        String url = "/v1/account/accounts/" + accountId + "/balance";
        BalanceResponse resp = get(url, null, new TypeReference<BalanceResponse>(){});
        return resp;
    }
     ...
     * @return
     */
    public BatchcancelResponse<Batchcancel<List<String>, List<BatchcancelBean>>> submitcancels(List orderList) {
        Map<String, List> parameterMap = Maps.newHashMap();
        parameterMap.put("order-ids", orderList);
        return post("/v1/order/orders/batchcancel", parameterMap, new TypeReference<BatchcancelResponse<Batchcancel<List<String>, List<BatchcancelBean>>>>() {});
    }

    /**
     * POST /v1/order/orders/batchCancelOpenOrders 批量取消符合条件的订单
     *
     * @param batchCancelOpenOrdersRequest
     * @return
     */
    public BatchCancelOpenOrdersResponse batchCancelOpenOrders(BatchCancelOpenOrdersRequest batchCancelOpenOrdersRequest) {
        BatchCancelOpenOrdersResponse resp = post("/v1/order/batchCancelOpenOrders", batchCancelOpenOrdersRequest, new TypeReference<BatchCancelOpenOrdersResponse<BatchCancelOpenOrders>>() {
        });
        return resp;
    }
    ...
    /**
     * GET /v1/order/openOrders 查询已提交但是仍未完全成交或未被撤销的订单。
     *
     * @param symbol
     * @param  size 100	[10,1000]
     * @return
     */
    public OrdersListResponse openOrders(String accountId, String symbol, Integer size) {
        HashMap map = new HashMap();
        map.put("account-id", accountId);
        map.put("symbol", symbol);
        map.put("size", "500");
        OrdersListResponse resp = get("/v1/order/openOrders/", map, new TypeReference<OrdersListResponse>() {
        });
        return resp;
    }

    /**
     * GET /v1/order/history 搜索最近48小时内历史订单
     *
     * @param symbol
     * @param  size 100	[10,1000]
     * @return
     */
    public OrdersListResponse ordersHistory(String symbol,Integer size) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        map.put("size", "1000");
        OrdersListResponse resp = get("/v1/order/history/", map, new TypeReference<OrdersListResponse>() {
        });
        return resp;
    }
    public OrdersListResponse ordersListByPage(Map<String, String> map) {
        OrdersListResponse resp = get("/v1/order/orders", map, new TypeReference<OrdersListResponse>() {
        });
        return resp;
    }
    public OrdersListResponse ordersHistoryAll(String symbol,String size,String direction,String from,String states) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        map.put("size", size);
        map.put("states", states);
        if (StringUtils.isNotEmpty(direction)){
            map.put("direct", direction);
            map.put("from", from);
        }
        OrdersListResponse resp = get("/v1/order/orders/", map, new TypeReference<OrdersListResponse>() {
        });
    ...
    public MatchresultsOrdersDetailResponse matchresultsBySymbol(Map map) {
        MatchresultsOrdersDetailResponse resp = get("/v1/order/matchresults/", map, new TypeReference<MatchresultsOrdersDetailResponse<List<MatchresultsOrdersDetail>>>() {
        });
        return resp;
    }

    /**
     * GET /v1/subuser/aggregate-balance 母账户查询其下所有子账号的各币种汇总余额
     *
     * @return
     */
    public AccountsResponse aggregateBalance() {
        AccountsResponse resp = get("/v1/subuser/aggregate-balance", null, new TypeReference<AccountsResponse<List<AggregateBalance>>>() {
        });
        return resp;
    }


    public IntrustDetailResponse intrustOrdersDetail(IntrustOrdersDetailRequest req, boolean isHadax) {
        HashMap map = new HashMap();
        ...
        IntrustDetailResponse resp;
        if (isHadax) {
            resp = getHadax("/v1/order/orders/", map, new TypeReference<IntrustDetailResponse<List<IntrustDetail>>>() {
            });
        } else {
...
//  }
    ...
    // send a GET request.
    public <T> T getHadax(String uri, Map<String, String> params, TypeReference<T> ref) {
        if (params == null) {
            params = new HashMap<>();
        }
        return callHadax("GET", uri, null, params, ref);
    }
    ...
    public <T> T postHadax(String uri, Object object, TypeReference<T> ref) {
        return callHadax("POST", uri, object, new HashMap<String, String>(), ref);
    }

    // call api by endpoint.
    private <T> T call(String method, String uri, Object object, Map<String, String> params,
                       TypeReference<T> ref) {
        return call(method, uri, object, params, ref, API_URL);
    }

    private <T> T callHadax(String method, String uri, Object object, Map<String, String> params,
                            TypeReference<T> ref) {
        return call(method, uri, object, params, ref, API_URL_HADAX);
    }

    private <T> T call(String method, String uri, Object object, Map<String, String> params,
                       TypeReference<T> ref, String apiUrl) {
        if(StringUtils.isNotBlank(this.accessKeyId)&&StringUtils.isNotBlank(this.accessKeySecret)){
        ...
        try {
            ...
            throw new TradeExchangeApiException(e);
        }
    }
