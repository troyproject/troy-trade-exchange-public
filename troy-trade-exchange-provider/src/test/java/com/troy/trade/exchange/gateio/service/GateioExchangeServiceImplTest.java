...
@SpringBootTest
public class GateioExchangeServiceImplTest {
    ...
    public void getOrderBook() {
        ...
        orderBookReqDto.setExchCode(ExchangeCode.GATEIO);
    ...
    public void getTrades() {
        ...
        tradeHistoryReqDto.setExchCode(ExchangeCode.GATEIO);
    ...
    public void getSymbolInfo() {
        ...
        symbolInfoReqDto.setExchCode(ExchangeCode.GATEIO);
    ...
    public void fullTickers() {
        ...
        fullTickerReqDto.setExchCode(ExchangeCode.GATEIO);
